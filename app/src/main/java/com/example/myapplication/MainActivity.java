...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void createTask2() {
        TableRow push = (TableRow)findViewById(R.id.createBtn);
        Button btn = new Button(this);
        btn.setText("/");
        btn.setTag("button_divide");
        btn.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.MATCH_PARENT, TableRow.LayoutParams.MATCH_PARENT));
        push.addView(btn);
    }
